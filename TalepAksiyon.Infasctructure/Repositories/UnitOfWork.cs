...
namespace TalepAksiyon.Infasctructure.Repositories
{
  public class UnitOfWork /*: IUnitOfWork*/
  {
    ...
    //public UnitOfWork(TalepAksiyonContext _context, ISessionService sessionService, IEmailService _emailService)
    //{
    ...
    //public IRepository Repository => _repository ?? (_repository = new Repository(context, session));     private ICustomerRepository _customerRepository;
    ...
    //public IRequestRepository RequestRepository =>_requestRepository ?? (_requestRepository = new RequestRepository(context, session, this));
